          ...
          body: SafeArea(
            ...
            child: Stack(
              children: [
                                                        ...
                                                        padding:
                                                            EdgeInsetsDirectional
                                                                .fromSTEB(
                                                                    0, 4, 0, 0),
                                                        child: Text(
                                                          'buy 1 get 1 dengan menggunakan bank bca',
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .bodyMedium,
                                                        ),
                ...
                Align(
                  alignment: AlignmentDirectional(0.45, 1.01),
                  child: Row(
                    mainAxisSize: MainAxisSize.max,
                    children: [
                      Padding(
